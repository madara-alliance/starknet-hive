...
impl RunnableTrait for TestCase {
    ...
    async fn run(test_input: &Self::Input) -> Result<Self, OpenRpcTestGenError> {
        let initial_balance = *test_input
            ...
            .await?
            .first()
            .ok_or(OpenRpcTestGenError::Other("Initial contract balance is empty".to_string()))?;
        ...
        let updated_balance = *test_input
            ...
            .await?
            .first()
            .ok_or(OpenRpcTestGenError::Other("Updated contract balance is empty".to_string()))?;
